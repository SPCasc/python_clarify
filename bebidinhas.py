...
# ===================================
# FILTROS - MOSTRAR APENAS O ACIMA DA MÉDIA
# ===================================

mediaAlcool = df["LitrosAlcool"].mean()
print("\n===ACIMA DA MÉDIA DE ALCOOL ===")
print(
...
# ===================================
# CORRELAÇÃO - aproveite para aprender sobre a fórmula de pearson
# ===================================
...
print(
    df[
        [
            "Cerveja", "Destilados", "Vinho", "LitrosAlcool"
        ]
    ].corr()
)
